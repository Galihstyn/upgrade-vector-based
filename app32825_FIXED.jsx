...
const AppContent = () => {
  ...
  // ⚡ Bolt Optimization: Switched to lazy initialization for expensive refs.
  // Previously, functions like `getThemeBootstrap` (DOM queries) and `safeClone` (JSON parse/stringify)
  // were executed on every single render to pass arguments to `useRef`.
  // Impact: Removes unnecessary main-thread blocking operations from the render hot-path.
