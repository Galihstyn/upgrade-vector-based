...
const AppContent = () => {
  ...
  const handleBackNavigation = useCallback(() => {
    ...
    // Security Fix: Prevent XSS and path traversal by encoding the product handle
    ...
    try {
      if (document.referrer) {
        ...
        // Security Fix: Prevent open redirect via "null" origin or protocol-relative URLs
        if (
