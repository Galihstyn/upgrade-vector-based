...
const AppContent = () => {
  ...
  if (themeBootstrapRef.current === null) {
    ...
    themeBootstrapRef.current = themeBootstrap;
    bootBackgroundRef.current = themeBootstrap?.background
      ? safeClone({ ...themeBootstrap.background, locked: true })
      : null;
    const editorContextSignature =
      getThemeBootstrapContextSignature(themeBootstrap);
    editorContextSignatureRef.current = editorContextSignature;
    projectStorageKeyRef.current = buildProjectStorageKey(
      editorContextSignature,
    );
  }
