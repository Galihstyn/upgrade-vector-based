    ...
    <div className="relative h-screen w-full bg-[#0a0f1d] text-slate-200 overflow-hidden font-sans select-none touch-none">
      ...
      <div className="absolute top-[80px] left-1/2 -translate-x-1/2 bg-[#1e293b]/90 backdrop-blur-xl border border-slate-700/50 shadow-lg flex flex-row items-center z-40 transition-all duration-500 h-10 w-max rounded-full px-2 gap-1.5 md:gap-2">
        <button
          ...
          title="Undo"
          aria-label="Undo"
          className="w-8 h-8 flex items-center justify-center hover:bg-slate-700 rounded-full disabled:opacity-20 text-indigo-400 transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500"
        >
        ...
        <button
          ...
          title="Zoom In"
          aria-label="Zoom In"
          className="w-8 h-8 flex items-center justify-center text-slate-400 hover:text-white hover:bg-slate-700 rounded-full transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500"
        >
