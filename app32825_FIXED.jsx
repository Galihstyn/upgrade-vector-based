...
// ⚡ Bolt: Optimize bounding box calculations with a single-pass loop.
// Impact: Replaces 4x O(N) Array.map() allocations and spread operators (...) with 1x O(N) loop.
// Prevents "Maximum call stack size exceeded" errors when spreading large custom point arrays.
