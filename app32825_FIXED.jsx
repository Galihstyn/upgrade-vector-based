...
const AppContent = () => {
  ...
  // Optimize selection lookups from O(M) array search to O(1) Set lookup
  ...
  }, [elements, background, selectedIds, selectedSet, applyElementsUpdate]); // Note: We pass applyElementsUpdate safely
  ...
  }, [selectedIds, selectedSet, applyElementsUpdate]);
