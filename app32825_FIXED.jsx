...
const getWarpMetrics = (el) => {
  ...
  const positions = chars.map((char, charIdx) => {
    ...
    // Performance optimization: Pre-calculate sin/cos and unroll corner matrix calculation
    // This avoids mapping arrays and creating temporary objects per character during warp renders
