...
const AppContent = () => {
  ...
  // ⚡ Bolt: Performance Optimization - Memoize selected element lookups
  // Converting `selectedIds` to a `Set` reduces the lookup time complexity
  // inside array operations (map/filter) and rendering cycles from O(N) to O(1).
