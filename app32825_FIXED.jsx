...
const AppContent = () => {
  ...
  // Use lazy initialization for refs that rely on expensive DOM operations and JSON parsing
  // to avoid executing them on every render cycle (e.g. 60fps while dragging objects).
