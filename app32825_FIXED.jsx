...
const AppContent = () => {
  ...
  const handleBackNavigation = useCallback(() => {
    ...
    // Security: encode user-provided handle to prevent path traversal
    ...
    try {
      if (document.referrer) {
        ...
        // Security: Ensure origin is valid (not null), matches window, and path doesn't start with //
        if (
          ...
          // Security: only use path components for safe internal redirect
