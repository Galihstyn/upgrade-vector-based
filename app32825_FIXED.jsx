...
const getWarpMetrics = (el) => {
  ...
  const positions = chars.map((char, charIdx) => {
    ...
    // Performance Optimization: Hoist trigonometric calculations and eliminate array allocations (.map/.forEach)
    // Avoids GC pressure and redundant math operations in hot loop during drag/warp rendering
